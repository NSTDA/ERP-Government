====================================
Budget Control - Excel Import/Export
====================================
...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Faccount--budgeting-lightgray.png?logo=github
    :target: https://github.com/OCA/account-budgeting/tree/15.0/egov_budget_control_excel_import_export
    :alt: OCA/account-budgeting
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.odoo-community.org/projects/account-budgeting-15-0/account-budgeting-15-0-egov_budget_control_excel_import_export
...
`feedback <https://github.com/OCA/account-budgeting/issues/new?body=module:%20egov_budget_control_excel_import_export%0Aversion:%2015.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/account-budgeting <https://github.com/OCA/account-budgeting/tree/15.0/egov_budget_control_excel_import_export>`_ project on GitHub.
